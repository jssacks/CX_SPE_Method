#####
##This script imports the raw skyline output files for the RP PPL analytical validation (AV)
...
write_csv(AV.RP.full.export, path = "Intermediates/Analytical_Validation/AV_PPL_RP_combined_raw.csv")
...
write_csv(full.IS, path = "Intermediates/Analytical_Validation/AV_PPL_RP_IS.csv")
...
write_csv(rp.smp.list.AV, path = "Intermediates/Analytical_Validation/AV_PPL_RP_Samp_List.csv")
