...
samp.key.file <- "Intermediates/Analytical_Validation/AV_PPL_RP_Samp_List.csv"
is.dat.file <- "Intermediates/Analytical_Validation/AV_PPL_RP_IS.csv"
xcms.dat.file <- "Intermediates/Analytical_Validation/AV_PPL_RP_combined_raw.csv"
cut.off <- 0.2
cut.off2 <- 0.1
...
###Adjust for decreases in peak area caused by dividing by injection volume
...
write_csv(BMIS_normalizedData.2, "Intermediates/Analytical_Validation/AV_PPL_RP_BMISed_dat.csv")
